...
import { useCompanies, useContacts, useCreateInvoice } from "@/lib/hooks";
import { useSession } from "@/lib/auth-client";
import type { Company, Contact, TemplateId } from "@/lib/types";
...
export default function InvoiceEditorPage() {
  ...
  // Prefill the issuer from the active company once data loads.
  const didPrefill = useRef(false);
  useEffect(() => {
    if (didPrefill.current || !companies.length) return;
